    ...
    <nav class="t-header">
        ...
        <div class="t-header-content-wrapper">
            <div class="t-header-content">
                ...
                <h4 class="logo text-center mt-50 ">QUARANTECH</h4>
    ...
    <div class="page-body">
        ...
        <div class="sidebar">
            <ul class="navigation-menu">
                ...
                <li>
                    <a href="#ManageProduct" data-toggle="collapse" aria-expanded="false">
                        <span class="link-title">Management</span>
                        <i class="mdi mdi-database link-icon"></i>
                    </a>
                    <ul class="collapse navigation-submenu" id="ManageProduct">
                        <li>
                            <a href="#" style="color: rgb(12, 12, 12);" target="_blank">Products</a>
                        </li>
                        <li>
                            <a href="#" style="color: rgb(15, 15, 15);" target="_blank">Shop</a>
                        </li>
                        <li>
                            <a href="#" style="color: rgb(0, 0, 0);" target="_blank">Payment</a>
                        </li>
                        <li>
                            <a href="#" style="color: rgb(0, 0, 0);"target="_blank">Customer</a>
                        </li>
                        <li>
                            <a href="#" style="color: rgb(0, 0, 0);" target="_blank">Control-Panel</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <div class="content-viewport">
                    <div class="row">
                        <div class="col-12 py-5">
                            <h4>Dashboard</h4>
                            <p class="text-gray">Desciption</p>
                        </div>
                    </div>
                    <div class="row">
                        <h1 class="form-control">CODE HERE!</h1>
                    </div>
                </div>
            </div>
        </div>
